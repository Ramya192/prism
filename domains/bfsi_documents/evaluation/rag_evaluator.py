"""
domains/bfsi_documents/evaluation/rag_evaluator.py
Ported from document_intelligence_system/evaluation/rag_evaluator.py —
logic unchanged, import path moved under domains.bfsi_documents.
...
class RAGASEvaluator:
    ...
    def __init__(self):
        ...
        self.ground_truth = (
            json.load(open(_GROUND_TRUTH_PATH)) if _GROUND_TRUTH_PATH.exists() else {}
        )
