"""
domains/bfsi_documents/tools/bulk_ingest.py
...
Usage (from the prism/ repo root):
    python domains/bfsi_documents/tools/bulk_ingest.py

Optional: ingest a specific range
    python domains/bfsi_documents/tools/bulk_ingest.py --start 50 --end 100
"""
