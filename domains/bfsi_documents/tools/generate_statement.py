"""
domains/bfsi_documents/tools/generate_statement.py
...
Usage (from the prism/ repo root):
    python domains/bfsi_documents/tools/generate_statement.py

Output:
    domains/bfsi_documents/data/statements/AC00001_statement.pdf
    domains/bfsi_documents/data/statements/AC00002_statement.pdf
    ...
...
# ── Constants ─────────────────────────────────────────────────────────────────
_HERE = Path(__file__).parent.parent  # domains/bfsi_documents/
