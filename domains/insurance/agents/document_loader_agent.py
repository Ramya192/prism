# domains/insurance/agents/document_loader_agent.py
# Subclasses core/rag/base_document_loader_agent.py -- no metadata
# override needed (a claim document doesn't need a bank-name-style
# detector). Accepts PDF/DOCX/CSV like every other document-capable
