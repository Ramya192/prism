# domains/insurance/data/ingest_reference_corpus.py
# One-time (idempotent -- see core/rag/reference_corpus.py) ingestion of
# Insurance's static reference corpus into the vector DB, so chat
# retrieval can draw on it alongside whatever claim document a user
...
REFERENCE_FILE = Path(__file__).parent.parent / "reference_corpus" / "cms_claims_processing_excerpt.txt"
