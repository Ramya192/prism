# domains/financial_services/settings.py
...
# domains/insurance/settings.py) once Financial Services gained a
...
class Settings:
    ...
    COLLECTION_NAME = os.getenv("FINANCIAL_SERVICES_COLLECTION_NAME", "fintech_statements")
