# domains/banking/fraud/evaluate.py
...
# Run from the prism/ repo root: python domains/banking/fraud/evaluate.py
# Requires domains/banking/fraud/data/train.csv and test_holdout.csv — regenerate
