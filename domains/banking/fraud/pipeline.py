# domains/banking/fraud/pipeline.py
...
from domains.banking.fraud.agents.analyst_agent import AnalystAgent
from domains.banking.fraud.agents.alert_agent import AlertAgent
